...
import StaffDeleteModal from "components/features/staff/components/StaffDeleteModal";
...
export default function StaffPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (s) => (
        <span className="truncate text-sm text-slate-700">{s.department || <span className="text-slate-300">—</span>}</span>
      ),
    },
    {
      key: "position",
      ...
      render: (s) => (
        <span className="truncate text-sm text-slate-700">{s.position || <span className="text-slate-300">—</span>}</span>
      ),
    },
    {
      key: "status",
      ...
      render: (s) => (
        <div className="flex items-center justify-end gap-0.5">
          ...
          <RowIconButton
            ...
            title="Edit"
            onClick={() => navigate(`/admin/staff/${s.id}/edit`)}
          />
          <RowIconButton
    ...
    <div className="max-w-5xl mx-auto bg-white p-6 rounded-2xl border border-slate-200">
      ...
      <DataTable
        ...
        emptyAction={!hasFilters
          ? { label: "Add Staff", onClick: () => navigate("/admin/staff/create") }
          : undefined}
      />
