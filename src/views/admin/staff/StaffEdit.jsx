...
import { MdArrowBack, MdVerified, MdEdit, MdBadge } from "react-icons/md";
      ...
      <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          ...
          <div className="grid grid-cols-1 gap-x-5 sm:grid-cols-2">
            <InputField label="Full Name"     field="full_name"    placeholder="Ahmad Farid"       formData={userForm} errors={errors} updateFormData={setU} />
            <InputField label="Email Address" field="email"        type="email" placeholder="ahmad@example.com" formData={userForm} errors={errors} updateFormData={setU} />
          </div>
          <div className="grid grid-cols-1 gap-x-5 sm:grid-cols-2">
