...
export default function StaffCreateForm() {
  ...
  const canSubmit =
    userForm.full_name.trim() && userForm.email.trim() &&
    userForm.password && staffForm.employee_id.trim();
    ...
    <div className="mx-auto max-w-5xl flex flex-col gap-4 rounded-2xl border border-slate-200 bg-white p-6">
      ...
      <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          ...
          <div className="grid grid-cols-1 gap-x-5 sm:grid-cols-2">
            <InputField label="Employee ID" field="employee_id" placeholder="EMP001"       formData={staffForm} errors={errors} updateFormData={setS} rules={STAFF_RULES.employee_id} />
