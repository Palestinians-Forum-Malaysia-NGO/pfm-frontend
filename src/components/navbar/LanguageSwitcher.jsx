...
export default function LanguageSwitcher() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {/* Dropdown */}
      <div className={`absolute end-0 top-full z-50 mt-2 w-36 origin-top-right overflow-hidden rounded-xl border border-slate-200 bg-white shadow-lg shadow-slate-200/60 transition-all duration-200 ${
