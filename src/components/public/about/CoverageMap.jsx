  ...
  return (
    <section ref={ref} className="bg-slate-50 py-20">
      <div className="mx-auto max-w-5xl px-6">
        ...
        >
          <span className="text-xs font-bold uppercase tracking-widest text-green">Where We Are</span>
          <h2 className="mt-3 text-4xl font-extrabold text-slate-900">Our Reach Across Malaysia</h2>
          <p className="mx-auto mt-3 max-w-md text-base text-slate-400">
            PFM has an active presence in major cities across Malaysia, bringing the community together nationwide.
          </p>
        </div>
