...
export const inputCls = (hasError) =>
  `h-12 w-full rounded-xl border px-3 text-sm text-slate-900 text-start outline-none transition-all placeholder:text-slate-400 ${
    hasError
...
export const dropdownSearchCls =
  "mb-2 h-9 w-full rounded-lg border border-slate-200 bg-slate-50 px-3 text-sm text-start outline-none transition-all focus:border-green focus:bg-slate-100/70 placeholder:text-slate-400";
